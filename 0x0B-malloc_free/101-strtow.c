...
#include "main.h"
/**
 * strncat_mod - concatenates strings with n bytes from another string.
...
/**
 * mallocmen - allocates memory for output array and sets NULL at string end.
 * @newstr: new string.
 * @str: input string.
 * @str_len: string length.
 * Return: void.
 */
void mallocmen(char **newstr, char *str, int str_len)
{
...
/**
 * word_count - counts words in string input.
 * @str: input string.
 * @str_len: string length.
 * Return: 0 on failure, words on succes.
 */
